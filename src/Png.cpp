...
int Png::readImage(){
    ...
    errHandle->printLog("Calling read method\n");
    int pChannels;
    ...
    errHandle->printLog("Filling up the bitmap header\n");
...
int Png::readpng_get_bgcolor(uint8_t *red, uint8_t *green, uint8_t *blue){
    ...
    errHandle->printLog("No background color found\n");
        *red = *green = *blue = 255;
    }
...
int Png::readpng_get_image(double display_exponent, int *pChannels, unsigned long *pRowBytes){
    ...
    *pChannels = (int)png_get_channels(png_ptr, info_ptr);
    ...
    pData = NULL;
    errHandle->printLog("Allocating memory\n");
